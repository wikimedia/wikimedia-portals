 ...
 *
 */
/* global _, addEvent, removeEvent, doWhenReady */
...
( function ( lp ) {
	...
	doWhenReady( function () {
		...
		} else if ( select && select.tagName === 'UL' ) {
	...
	doWhenReady( function () {
		 ...
		 * @private
		 */
		lp.searchInput = document.getElementById( 'searchInput' );
		...
		function onLanguageChanged( lang ) {
			textContent( selectedLanguageEl, lang.toUpperCase() );
		...
		lp.open = function () {
			...
			var windowScroll = window.pageYOffset,
				...
				distanceToTop = lp.searchInput.offsetParent.offsetTop,
				ddSize = 192;
