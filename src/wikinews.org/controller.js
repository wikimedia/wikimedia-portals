...
const searchLanguageWikis = stats.getRange( 'wikinews', 'numPages', 1000 );
const searchLanguageDropdown = stats.format( 'wikinews', searchLanguageWikis, {
	stripTags: true
} );
 ...
 */
const siteStats = {};
const range = stats.getRangeFormatted( 'wikinews', 'views', 10 );
