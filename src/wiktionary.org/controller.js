...
l10n.assets = {
	...
	logo: {
		...
		srcset: 'portal/wiktionary.org/assets/img/Wiktionary-logo-tiles_2x.png 2x',
		width: '200',
		height: '183'
	},
	lang: {
...
const searchLanguageWikis = stats.getRange( 'wiktionary', 'numPages', 100000 );
const searchLanguageDropdown = stats.format( 'wiktionary', searchLanguageWikis, {
	stripTags: true
} );
 ...
 */
const siteStats = {};
const range = stats.getRangeFormatted( 'wiktionary', 'views', 10 );
