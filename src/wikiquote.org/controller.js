...
const searchLanguageWikis = stats.getRange( 'wikiquote', 'numPages', 1000 );
const searchLanguageDropdown = stats.format( 'wikiquote', searchLanguageWikis, {
	stripTags: true
} );
 ...
 */
const siteStats = {};
const range = stats.getRangeFormatted( 'wikiquote', 'views', 10 );
